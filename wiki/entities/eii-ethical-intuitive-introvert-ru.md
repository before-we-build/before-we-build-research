...
updated: 2026-08-30
lang: ru
sources: ["raw/socionics/what-is-socionics.md", "raw/socionics/model-a.md", "wiki/entities/socionics-overview-ru.md", "wiki/concepts/compatibility-level-boundaries-ru.md", "wiki/concepts/test-result-reading-guide-ru.md"]
...
claims:
  - id: eii-model-a-code-is-source-attributed
    status: source-attribution
  - id: eii-information-pattern-is-research-hypothesis
    status: research-hypothesis
caveat_ids: [no-personality-determinism, no-moral-or-safety-inference, no-relation-verdict]
---
...
- Обозначение Модели A, используемое в репозитории: **1Fi 2Ne 3Se 4Ti 5Fe 6Ni 7Si 8Te**
