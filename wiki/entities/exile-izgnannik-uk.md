...
translation_group: exile-izgnannik
semantic_version: 1
...
[[exile-izgnannik-en|English]] · [[exile-izgnannik-ru|Русский]] · Українська

<!-- section:definition -->
**3N** розміщує аспект **Теперішнє** у 3-й позиції Темпористики. Це стратегічна часово-смислова гіпотеза, а не діагноз, духовний статус, сутність особистості або передбачення.

<!-- section:meaning -->
## Короткий зміст

**Вигнанець** — традиційна робоча назва для **3N / Теперішнє**. Позиція моделюється як чутлива зона перевірки помилок і перегляду. Назва слугує мнемонікою, а не позначенням спостережуваного типу людини.
