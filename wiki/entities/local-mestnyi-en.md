...
English · [[local-mestnyi-ru|Русский]] · [[local-mestnyi-uk|Українська]]

<!-- section:definition -->
**2N** places **Present** in position 2 of Temporistics. This is a strategic temporal-existential hypothesis, not a diagnosis, spiritual status, personality essence, or prediction.

<!-- section:meaning -->
## Compact meaning

**Local** is a traditional working alias for **2N / Present**. The position is modeled as a collaborative and adaptive process. The alias is a mnemonic, not an observable kind of person.
