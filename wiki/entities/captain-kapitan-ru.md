...
**Капитан** — традиционное рабочее название для **1F / Будущее**. Позиция моделируется как автономная организующая рамка. Название служит мнемоникой, а не обозначением наблюдаемого типа человека.
