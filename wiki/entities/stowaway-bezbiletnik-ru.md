...
**Безбилетник** — традиционное рабочее название для **3F / Будущее**. Позиция моделируется как чувствительная зона проверки ошибок и пересмотра. Название служит мнемоникой, а не обозначением наблюдаемого типа человека.
