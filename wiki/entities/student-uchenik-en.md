...
translation_group: student-uchenik
semantic_version: 1
...
English · [[student-uchenik-ru|Русский]] · [[student-uchenik-uk|Українська]]

<!-- section:definition -->
**4E** places **Eternity** in position 4 of Temporistics. This is a strategic temporal-existential hypothesis, not a diagnosis, spiritual status, personality essence, or prediction.

<!-- section:meaning -->
## Compact meaning

**Student** is a traditional working alias for **4E / Eternity**. The position is modeled as a receptive or externally supported frame. The alias is a mnemonic, not an observable kind of person.
