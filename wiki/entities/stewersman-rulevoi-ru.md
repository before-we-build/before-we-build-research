...
**Рулевой** — традиционное рабочее название для **2F / Будущее**. Позиция моделируется как совместный и адаптивный процесс. Название служит мнемоникой, а не обозначением наблюдаемого типа человека.
