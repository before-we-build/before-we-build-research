...
[[guest-gost-en|English]] · Русский · [[guest-gost-uk|Українська]]

<!-- section:definition -->
**4N** помещает аспект **Настоящее** в 4-ю позицию Темпористики. Это стратегическая временно-смысловая гипотеза, а не диагноз, духовный статус, сущность личности или предсказание.

<!-- section:meaning -->
## Краткий смысл

**Гость** — традиционное рабочее название для **4N / Настоящее**. Позиция моделируется как принимающая или поддерживаемая извне рамка. Название служит мнемоникой, а не обозначением наблюдаемого типа человека.
