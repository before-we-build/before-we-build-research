---
title: Психософский тип ЛВЭФ (LVEF)
type: entity
tags: [psychosophy, operational-level, type-hypothesis, lvef, ru]
created: 2026-04-30
updated: 2026-08-30
lang: ru
sources: ["wiki/entities/psychosophy-overview-ru.md", "wiki/concepts/compatibility-level-boundaries-ru.md", "wiki/concepts/test-result-reading-guide-ru.md"]
translation_group: psychosophy-type-lvef
semantic_version: 1
...
caveat_ids: []
---
# Психософский тип ЛВЭФ (LVEF)

[[psychosophy-type-lvef-en|English]] · Русский · [[psychosophy-type-lvef-uk|Українська]]

<!-- section:definition -->
Страница фиксирует **гипотезу типа Психософии** на операционном уровне совместного действия. Код — это компактная модель возможного паттерна восприятия или организации опыта. Он не является наблюдаемым объектом, полным описанием человека, диагнозом или детерминированным вердиктом.
