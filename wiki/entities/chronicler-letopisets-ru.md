...
translation_group: chronicler-letopisets
semantic_version: 1
...
[[chronicler-letopisets-en|English]] · Русский · [[chronicler-letopisets-uk|Українська]]

<!-- section:definition -->
**2P** помещает аспект **Прошлое** в 2-ю позицию Темпористики. Это стратегическая временно-смысловая гипотеза, а не диагноз, духовный статус, сущность личности или предсказание.

<!-- section:meaning -->
## Краткий смысл

**Летописец** — традиционное рабочее название для **2P / Прошлое**. Позиция моделируется как совместный и адаптивный процесс. Название служит мнемоникой, а не обозначением наблюдаемого типа человека.
