...
translation_group: kritik-critic
semantic_version: 1
...
[[kritik-critic-en|English]] · Русский · [[kritik-critic-uk|Українська]]

<!-- section:definition -->
**3P** помещает аспект **Прошлое** в 3-ю позицию Темпористики. Это стратегическая временно-смысловая гипотеза, а не диагноз, духовный статус, сущность личности или предсказание.

<!-- section:meaning -->
## Краткий смысл

**Критик** — традиционное рабочее название для **3P / Прошлое**. Позиция моделируется как чувствительная зона проверки ошибок и пересмотра. Название служит мнемоникой, а не обозначением наблюдаемого типа человека.
