...
English · [[avtor-author-ru|Русский]] · [[avtor-author-uk|Українська]]

<!-- section:definition -->
**1P** places **Past** in position 1 of Temporistics. This is a strategic temporal-existential hypothesis, not a diagnosis, spiritual status, personality essence, or prediction.

<!-- section:meaning -->
## Compact meaning

**Author** is a traditional working alias for **1P / Past**. The position is modeled as an autonomous organizing frame. The alias is a mnemonic, not an observable kind of person.
