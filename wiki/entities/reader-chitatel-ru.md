...
translation_group: reader-chitatel
semantic_version: 1
...
[[reader-chitatel-en|English]] · Русский · [[reader-chitatel-uk|Українська]]

<!-- section:definition -->
**4P** помещает аспект **Прошлое** в 4-ю позицию Темпористики. Это стратегическая временно-смысловая гипотеза, а не диагноз, духовный статус, сущность личности или предсказание.

<!-- section:meaning -->
## Краткий смысл

**Читатель** — традиционное рабочее название для **4P / Прошлое**. Позиция моделируется как принимающая или поддерживаемая извне рамка. Название служит мнемоникой, а не обозначением наблюдаемого типа человека.
