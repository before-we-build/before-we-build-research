...
English · [[chronicler-letopisets-ru|Русский]] · [[chronicler-letopisets-uk|Українська]]

<!-- section:definition -->
**2P** places **Past** in position 2 of Temporistics. This is a strategic temporal-existential hypothesis, not a diagnosis, spiritual status, personality essence, or prediction.

<!-- section:meaning -->
## Compact meaning

**Chronicler** is a traditional working alias for **2P / Past**. The position is modeled as a collaborative and adaptive process. The alias is a mnemonic, not an observable kind of person.
