...
**Пасажир** — традиційна робоча назва для **4F / Майбутнє**. Позиція моделюється як приймальна або підтримувана ззовні рамка. Назва слугує мнемонікою, а не позначенням спостережуваного типу людини.
