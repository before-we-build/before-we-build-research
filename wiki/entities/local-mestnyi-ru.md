...
translation_group: local-mestnyi
semantic_version: 1
...
[[local-mestnyi-en|English]] · Русский · [[local-mestnyi-uk|Українська]]

<!-- section:definition -->
**2N** помещает аспект **Настоящее** в 2-ю позицию Темпористики. Это стратегическая временно-смысловая гипотеза, а не диагноз, духовный статус, сущность личности или предсказание.

<!-- section:meaning -->
## Краткий смысл

**Местный** — традиционное рабочее название для **2N / Настоящее**. Позиция моделируется как совместный и адаптивный процесс. Название служит мнемоникой, а не обозначением наблюдаемого типа человека.
