...
The report compares software components and architectural tradeoffs for conversational, retrieval, workflow, and observability systems.

<!-- section:source-evidence -->
### Data or Evidence Provided

It summarizes official documentation, repositories, and published benchmarks; it does not provide one controlled benchmark across all listed projects.

<!-- section:source-limitations -->
### Limitations

Versions, pricing, performance, and security features change, while vendor benchmarks and heterogeneous workloads are not directly comparable.

<!-- section:bwb-accepts -->
### What BWB Accepts

BWB accepts the engineering decision criteria, reproducibility questions, and privacy and observability checklists for weak-assistant tooling.

<!-- section:bwb-contested -->
### What Remains Contested or Open

Current comparative performance, operational cost, and best fit for a particular deployment remain open and require local testing.

<!-- section:bwb-rejected-or-historical -->
### Rejected or Historical-Only

BWB rejects treating software capability as evidence about a person's psychology or using infrastructure output as an automatic relationship decision.
