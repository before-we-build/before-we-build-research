...
- **Colossians 3:12–14** — stable relationships require forgiveness and love.
- **Matthew 7:24–25** — the foundation matters more than appearance.
- **Hebrews 10:24–25** — community support is part of Christian life.
...
- **James 4:13–15** — future outcomes are not guaranteed by human planning.
- **Proverbs 19:20–21** — counsel and planning are helpful but limited.
...
- **2 Corinthians 4:2** — reject hidden and manipulative practices.
- **Ephesians 4:25** — speak truthfully.
- **Romans 12:17** — aim for what is honorable in the sight of all.
