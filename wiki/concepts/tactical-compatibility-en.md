...
English · [[tactical-compatibility-ru|Русский]] · [[tactical-compatibility-uk|Українська]]
...
For the move, one partner shares a spreadsheet of costs while the other needs a narrative of neighbourhood life and hidden risks. The task is to build a shared decision model, not to declare one information form superior.
...
Education, professional jargon, language proficiency, sensory access, neurodivergence, stress, status, and missing facts can create the same communication pattern.
...
Do not infer empathy, honesty, intelligence, morality, diagnosis, love, or destiny. Socionics Ni is not Temporistics Future; ethics functions are not Psychosophy Emotion.

<!-- section:conversation-questions -->
## Questions for conversation

- Which facts and representations does each person need?
- What did each person understand the other to mean?
- How will errors be checked and corrected?
- Is disagreement about facts, framing, or obligations?
