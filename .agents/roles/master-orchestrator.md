...
Use `.agents/ORGANIZATION.md` for the complete generated roster and task ownership.
Do not maintain a second team tree or route to planned agents.
...
- agent-improvement-steward: Controlled self-improvement loop for `.agents/roles/*.md`, improvement proposals, review-gated instruction patches
