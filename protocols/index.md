...
| `researcher-interest-maker` | Frame research relevance and hook points | Engages potential academic collaborators |
| `researcher-segmentation` | Segment researcher targets by academic disciplines | Improves relevance of outreach messaging |
...
├── evidence-packager.md            # Assemble research evidence packets
